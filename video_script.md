...
[VOICEOVER — softer, walking the viewer through it] (Audio: 1st.mpeg — 9.2s)
...
Files, in order: `v08_compensation.png` (6.2s) → `Referral Queue   with a new case visibly appearing.png` (6.2s)
...
Files, in order: `v09_case_details.png` (6.2s) → `Case Queue (IO).png` (6.2s) → `Case Detail screen showing FIR number CNR number and chargesheet status.png` (6.2s)
...
Files, in order: `v02_get_help_now.png` (6.2s) → `Protection Registry showing the new emergency referral landing, flagged as urgent.png` (6.2s)
...
Files, in order: `v10_legal_aid_hub.png` (6.2s) → `Legal Aid Queue screen.png` (6.2s) → `Case Hearing.png` (6.2s)
...
Files, in order: `v11_rehabilitation_progress.png` (6.2s) → `Referral Detail screen showing a named provider.png` (6.2s)

[VOICEOVER — warmer] (Audio: 5th.mpeg — 56.1s)
...
Files, in order: `Counsellor My user.png` (6.0s) → `v05_counsellor_chat.png` (6.0s) → `Counsellor - case_chat.png` (6.0s)
...
Files, in order: `Ai Voice call.mp4` (12.0s) → `AI video call.mp4` (18.0s) → `v07_ai_chat_selfharm_helpline.png` (8.1s)

[VOICEOVER] (Audio: 4th.mpeg — 11.7s)
...
Files, in order: `Counsellor -_notification_bell.png` (5.9s) → `Counsellor -_case_detail.png` (5.9s)

[VOICEOVER — shifts to the administrative view] (Audio: 6th.mpeg — 54.0s, continues through the closing line below)
...
File: `Analysis page  distress trend line chart.png` (9.0s)

A National Admin sees the same, across every state.

[ON SCREEN: National Admin Dashboard / heatmap]
File: `National admin dashboard.png` (9.0s)
...
Files, in order: `Ministry Dashboard.png` (9.0s) → `Ministry Report.png` (9.0s)

[VOICEOVER — closing, confident, warm, quieter] (same file: 6th.mpeg, no new audio cut)
...
Same file, cropped/zoomed on the docket-number row: `Ministry Report.png` (no separate hold — part of the shot above; ask the editor to punch in on this frame rather than requesting a new screenshot)
