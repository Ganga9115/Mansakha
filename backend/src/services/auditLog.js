...
// Build Prompt Section 0b: "write to it on every read/write of sensitive victim
...
async function writeAuditLog({ officialId = null, victimId = null, action, entityType, entityId = null }) {
