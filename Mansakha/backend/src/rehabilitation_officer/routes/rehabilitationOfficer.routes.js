...
// Rehabilitation Officer - copied from dwo/routes/dwo.routes.js (the
// template); ROLE_NAME differs. Post-case-closure phase run by government
// rehabilitation centers or NGOs - receives referrals either directly from
// District Admin or handed off from DWO once immediate relief is settled
// (see dwo.routes.js's own hand-off route, mirroring dlsa's mark-trial-ready
// pattern). Progress notes logged here are also surfaced read-only on the
...
const ROLE_NAME = 'Rehabilitation Officer';
