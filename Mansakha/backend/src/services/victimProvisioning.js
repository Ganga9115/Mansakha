...
async function createVictim({ docketNumber, fullName, contactNumber, jurisdictionId, caseTypeId, caseStage, provisionedVia, address = null, caseBackground = null }) {
  if (!docketNumber || !fullName || !contactNumber || !jurisdictionId || !caseTypeId || !caseStage) {
    throw new ProvisioningError('docketNumber, fullName, contactNumber, jurisdictionId, caseTypeId, and caseStage are required', 400);
  }
