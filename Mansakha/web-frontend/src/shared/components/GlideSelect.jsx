...
// Adapted from React Bits' GlideSelect - swapped @hugeicons/react for
// lucide-react (already this app's only icon dependency, used in every
// StaffLayout.jsx) so this doesn't introduce a redundant second icon
// system just for a chevron and a checkmark. Mechanism (pill glide via
// CSS transform/transition, keyboard nav, pointer-drag-to-select) is
// otherwise unchanged from the supplied source.
const SIZES = {
