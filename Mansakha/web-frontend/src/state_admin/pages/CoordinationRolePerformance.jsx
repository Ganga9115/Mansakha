      ...
      <div className="space-y-4">
        <div className="bg-white p-4 rounded-xl border border-gray-200/80 shadow-sm">
          ...
          <p className="text-[11px] text-gray-400 mt-1">
            ...
            Investigating Officer roles across your state's districts, and how their own referral queue is actually moving.
          </p>
        </div>
            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="divide-y divide-gray-100 text-xs">
                {!jurisdictionId || perfQuery.loading ? (
                  ...
                  <tr><td colSpan={6} className="py-8 text-center text-gray-400">No coordination-role officials assigned in your state yet.</td></tr>
                ) : officials.map((o) => (
