...
// State Admin compares its own districts - calls the exact same GET
// /api/admin/state/dashboard/:jurisdictionId StateDashboard.jsx already
// uses, just charting its `trends` array instead of tabling it, so these
// numbers can never drift from what the dashboard already shows.
