...
// State Admin's real district-wise report generate/submit/review workflow -
...
// cross-district comparison bars - that's analysis of State's ongoing
// caseload, not part of the periodic report record State actually sends
// upward, and didn't belong mixed into this page.
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white p-4 rounded-xl border border-gray-200/80 shadow-sm space-y-4">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div>
              <h3 className="font-bold text-sm text-gray-800">District-Wise Reports</h3>
              <p className="text-[11px] text-gray-400">Generate a district-wise rollup report and submit it to your National Admin.</p>
            </div>
            <button
