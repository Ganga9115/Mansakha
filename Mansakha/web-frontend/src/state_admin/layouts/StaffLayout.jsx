...
import { LayoutDashboard, BarChart3, Bell, User, LogOut, Search, Menu, X } from 'lucide-react';
...
// since comparing sub-jurisdictions makes sense here - State has districts
// to compare, unlike District Admin).
const NAV_ITEMS = [
  ...
  { name: 'Reports', icon: BarChart3, path: '/stateadmin/reports' },
  { name: 'Profile', icon: User, path: '/stateadmin/profile' },
];
