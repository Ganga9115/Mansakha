// Thin fetch wrapper - same pattern as every other role's own copy: attaches
// the JWT, unwraps the {success, data, message} envelope every backend route
// returns, and throws on failure so callers just await/try-catch instead of
// checking `.success` everywhere.
