...
// National Admin's own copy of the district drill-down view - reached via
// /nationaladmin/district/:jurisdictionId from StateDashboard.jsx's (this
// same folder's) "Drill Down" button, at the bottom of National -> State ->
// District -> Case navigation.
                  ...
                  {loading ? (
                    ...
                    <tr key={item.userId} className="hover:bg-gray-50/70 transition">
                      ...
                      <td className="py-3.5 px-6 text-right">
                        <button
                          onClick={() => navigate(`/nationaladmin/case-detail/${item.userId}`)}
