...
// National Admin's own copy of the Case File view - read-only (Administration
// never gets intervention-logging, note-composing, scheduling, or in-app
// chat, per the PS's explicit Counsellor/Administration split).
