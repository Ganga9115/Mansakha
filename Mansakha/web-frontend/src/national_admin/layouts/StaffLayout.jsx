...
const NAV_ITEMS = [
  ...
  { name: 'Analysis', icon: BarChart, path: '/nationaladmin/analysis' },
  { name: 'Coordination Roster', icon: Users2, path: '/nationaladmin/coordination-roster' },
          ...
          <div className="flex items-center gap-2 sm:gap-5 shrink-0">
            ...
            >
              ...
              <div className="text-xs hidden sm:block">
                ...
                <p className="text-brand-900/70">National Administration</p>
              </div>
            </button>
