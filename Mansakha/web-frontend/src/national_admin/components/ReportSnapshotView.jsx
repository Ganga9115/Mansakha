...
// National Admin's own copy of the structured report-snapshot renderer, used
...
// even though National itself only ever GENERATES state-wise (tier=
// 'national') snapshots - its own Inbox receives State's tier='state'
// snapshots from its own subtree - built generically anyway per the
// no-shared-imports convention (each tier's own byte-similar copy).
