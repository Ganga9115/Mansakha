...
// DWO's own proof-verified review queue for Financial Assistance and
// Medical Request Assistance submissions - District Admin no longer
// decides on these (see interventionRequestReview.js). Adapted from
...
// DWO's own referral queue). Accepting here creates a real agency_referral
// straight into the Referral Queue, carrying the verified proof forward.
        ...
        <div className="px-6 pb-5 text-xs text-gray-600 space-y-3">
          ...
          {r.status === 'Accepted' && (
            <p className="text-emerald-700 bg-emerald-50 border border-emerald-200 rounded-lg p-3">
              Accepted - a referral has been created in your Referral Queue for follow-up.
            </p>
          )}
        </div>
      )}
      ...
      <div className="space-y-4">
        <div className="bg-white p-4 rounded-xl border border-gray-200/80 shadow-sm space-y-4">
          <div>
            ...
            <p className="text-[11px] text-gray-400">Victims request Financial Assistance or Medical support with proof documents (FIR, caste certificate, bank passbook, medical certificate). Review and decide here - accepting creates a referral in your own Referral Queue.</p>
          </div>
