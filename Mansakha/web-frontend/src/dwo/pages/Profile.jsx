...
// District Welfare Officer's own copy of the shared Settings/Profile screen -
// copied from district_admin/pages/Settings.jsx (the template), reused
// as-is: /api/auth/staff/change-password and /api/me/profile-photo are both
...
export default function Profile() {
  ...
  const jobTitle = 'District Welfare Officer';
