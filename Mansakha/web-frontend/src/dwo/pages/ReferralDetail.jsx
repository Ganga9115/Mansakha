...
import { ArrowLeft, CheckCircle2, Send, HeartHandshake, ClipboardList } from 'lucide-react';
import { useReferralDetail, useAddReferralNote, useResolveReferral, useHandOffRehabilitation } from '../services/hooks';
...
// disclosure buried inside the list row). THE TEMPLATE reused verbatim
// across the other 6 role folders' identical component.
...
// District Welfare Officer's Referral Detail - the full case record for one
// referral: context, the notes thread, and every action (Resolve, Forward
// to Rehabilitation Officer, Assign Task), laid out as proper sections
// rather than crammed into an accordion. Structurally mirrors
// district_admin/pages/CaseDetail.jsx's header-summary + card-grid
// convention. THE TEMPLATE for the other 6 role folders' equivalent page.
  ...
  return (
    <StaffLayout title="Referral Detail">
      <div className="space-y-6">
        <button onClick={() => navigate('/dwo')} className="flex items-center gap-1.5 text-xs font-semibold text-gray-500 hover:text-gray-700 transition">
          <ArrowLeft size={14} /> Back to Referral Queue
        </button>
