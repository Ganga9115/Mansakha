...
// trimmed: no Mail/NotificationBell (out of scope for this role's first
// version), logout navigates to /signin (this role's own login surface)
// instead of /login. Rehabilitation is a separate role/portal now (not a
// tab here) - DWO hands off to it via a button on its own referral rows,
        ...
        <header className="h-16 bg-brand-50 border-b border-brand-100 px-4 sm:px-8 flex items-center justify-between shrink-0 gap-3">
          ...
          <div className="flex items-center gap-2 sm:gap-5 shrink-0">
            <div className="text-xs hidden sm:block text-right">
              ...
              <p className="text-brand-900/70">District Welfare Officer</p>
            </div>
