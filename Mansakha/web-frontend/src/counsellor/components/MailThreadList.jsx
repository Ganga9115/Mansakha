      ...
      <div className="flex-1 overflow-y-auto divide-y divide-gray-100">
        {loading ? (
          ...
          <div
            ...
            className={`group flex items-center gap-2.5 sm:gap-3 px-3 sm:px-4 py-2.5 cursor-pointer hover:bg-gray-50/80 hover:shadow-sm transition ${t.unread ? 'bg-brand-50/40' : ''}`}
          >
