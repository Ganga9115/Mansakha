...
export default function MailComposeModal({ onClose, onSent }) {
  ...
  return (
    ...
    <>
      ...
      <div className="fixed inset-0 lg:left-64 z-50 flex items-center justify-center p-2 sm:p-4 pointer-events-none">
      <div className="bg-white rounded-xl shadow-xl w-full max-w-lg flex flex-col max-h-[90vh] pointer-events-auto">
        <div className="flex items-center justify-between px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-100 shrink-0">
          <h3 className="text-base sm:text-lg font-bold text-gray-800">New Message</h3>
