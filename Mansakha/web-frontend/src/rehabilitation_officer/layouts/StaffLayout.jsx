...
import { Users, ClipboardList, User, LogOut, Menu, X } from 'lucide-react';
import { logout } from '../services/auth';
import { useMe } from '../services/hooks';

// Rehabilitation Officer's own dedicated shell - copied from
// dwo/layouts/StaffLayout.jsx (itself copied from district_admin's
// template). A genuinely separate role/portal (post-case-closure phase run
...
export default function StaffLayout({ children, title = 'Rehabilitation Plans' }) {
        ...
        <header className="h-16 bg-brand-50 border-b border-brand-100 px-4 sm:px-8 flex items-center justify-between shrink-0 gap-3">
          ...
          <div className="flex items-center gap-2 sm:gap-5 shrink-0">
            <div className="text-xs hidden sm:block text-right">
              ...
              <p className="text-brand-900/70">Rehabilitation Officer</p>
            </div>
