        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <BarChart
              ...
              items={regions.map((r) => ({ jurisdictionId: r.jurisdictionId, name: r.name, value: r.userCount }))}
              valueLabel="cases"
              barColor="bg-[#519BCE]"
            />
            <BarChart
            ...
            <DonutChart
              ...
              segments={[
                ...
                {
                  label: 'Low / unscored',
                  value: regions.reduce((sum, r) => sum + Math.max(0, (r.userCount || 0) - (r.critical || 0) - (r.highRisk || 0) - (r.vulnerable || 0)), 0),
                  color: '#10B981',
                },
              ]}
            />
