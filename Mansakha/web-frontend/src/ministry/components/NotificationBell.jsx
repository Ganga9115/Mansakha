...
// Ministry's own copy of the notification bell - real GET
// /api/me/notifications data. Ministry legitimately has nothing routed to
// it today (alert_notifications targets the assigned Counsellor + District
// Administration only), so an empty list here is correct, not a bug.
