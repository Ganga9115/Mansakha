      ...
      <div className="bg-white rounded-xl shadow-xl w-full max-w-lg flex flex-col max-h-[90vh] pointer-events-auto">
        ...
        <div className="flex-1 overflow-y-auto px-6 py-4 space-y-3">
          ...
          <div className="relative" ref={pickerRef}>
            <div className="flex flex-wrap items-center gap-1.5 px-3 py-2 border border-gray-200 rounded-lg focus-within:ring-1 focus-within:ring-brand-800">
              {recipients.map((r) => (
          ...
          <input
            ...
            placeholder="Subject"
            className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm font-medium outline-none focus:ring-1 focus:ring-brand-800"
          />
          ...
          <textarea
            ...
            rows={8}
            className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm outline-none resize-none focus:ring-1 focus:ring-brand-800"
          />
        ...
        <div className="flex items-center justify-between px-6 py-4 border-t border-gray-100 shrink-0">
          ...
          <button
            onClick={handleSend}
            disabled={sending}
            className="flex items-center gap-2 px-5 py-2 rounded-lg text-sm font-medium text-white bg-brand-900 hover:bg-brand-900 disabled:opacity-50 transition"
          >
