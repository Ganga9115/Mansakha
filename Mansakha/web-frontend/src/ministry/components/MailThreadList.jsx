    ...
    <div className="h-full flex flex-col bg-white rounded-xl border border-gray-200/80 shadow-sm overflow-hidden">
      <div className="px-4 py-3 border-b border-gray-100 shrink-0">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-9 pr-3 py-2 bg-brand-50 rounded-full text-gray-700 text-xs font-medium border-none focus:outline-none focus:ring-1 focus:ring-brand-800"
          />
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto divide-y divide-gray-100">
        {loading ? (
          ...
          >
            <span className={`w-1.5 h-1.5 rounded-full shrink-0 ${t.unread ? 'bg-brand-900' : 'bg-transparent'}`} />
