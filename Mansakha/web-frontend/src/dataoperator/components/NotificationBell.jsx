...
// Data Operator's own copy of the notification bell - real GET
// /api/me/notifications data. Data Operator legitimately has nothing routed
// to it today, so an empty list here is correct, not a bug.
