...
import { UserPlus, Users, FileSearch, Link2, User, LogOut, Menu, X, Mail } from 'lucide-react';
...
// shared StaffLayout, trimmed to just Data Operator's nav. Mail sits
...
const NAV_ITEMS = [
  ...
  { name: 'Mail', icon: Mail, path: '/dataoperator/mail' },
          ...
          <div className="flex items-center gap-2 sm:gap-5 shrink-0">
            ...
            >
              ...
              <div className="text-xs hidden sm:block">
                ...
                <p className="text-[#3D5A80]/70">Data Operator</p>
              </div>
            </button>
