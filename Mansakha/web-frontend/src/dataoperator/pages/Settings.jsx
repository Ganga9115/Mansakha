    ...
    <StaffLayout title="Profile">
      <div className="space-y-6">
        ...
        <div className="bg-white p-6 rounded-xl border border-gray-200/80 shadow-sm space-y-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500">Data Operator</p>
              <input
                type="file"
                accept="image/*"
                ref={fileInputRef}
        ...
        <div className="bg-white p-6 rounded-xl border border-gray-200/80 shadow-sm space-y-3">
          <h3 className="font-bold text-sm text-gray-800">Data Operator Details</h3>
          <DetailRow label="Scope" value="Not jurisdiction-restricted - can register users into any district" />
