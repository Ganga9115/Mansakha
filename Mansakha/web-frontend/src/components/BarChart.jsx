...
// Same "plain inline SVG-less div bars, no charting library" approach the
// Ministry Dashboard's trend chart already uses - this codebase has never
// taken a charting dependency, so every comparison chart is hand-rolled the
// same simple way instead of introducing one just for these pages.
