              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="bg-[#EBF4FA]/60 text-gray-600 text-[11px] uppercase tracking-wider font-semibold border-b border-gray-100">
                    <th className="py-3 px-6">Victim ID</th>
                ...
                <tbody className="divide-y divide-gray-100 text-xs">
                  {jurisdictionLoading || loading ? (
                    ...
                    <tr key={item.victimId} className="hover:bg-gray-50/70 transition">
                      <td className="py-3.5 px-6 font-bold text-gray-800">Case {item.victimId.slice(0, 8)}</td>
                      ...
                      <td className="py-3.5 px-6 text-right">
                        <button
                          onClick={() => navigate(`/${section}/case-detail/${item.victimId}`)}
                ...
                <div className="space-y-3 text-xs">
                  {data.alerts.map((a) => (
                    <div key={a.alertId} className="flex items-center justify-between border-b border-gray-50 pb-2">
                      <span className="text-gray-600 font-medium">Case {String(a.victimId).slice(0, 8)}</span>
