...
export default function AdminAlerts() {
  ...
  const section = location.pathname.startsWith('/nationaladmin') ? 'nationaladmin'
    : location.pathname.startsWith('/stateadmin') ? 'stateadmin'
    : 'districtadmin';
  const navigate = useNavigate();
  const [filter, setFilter] = useState('All');
  
  const { data: myJurisdiction, loading: jLoading } = useMyJurisdiction();
  ...
  return (
    <StaffLayout title="Alerts Feed" section={section}>
