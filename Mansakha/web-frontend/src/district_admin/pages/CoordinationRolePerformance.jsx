...
// and AdminDashboard.jsx already use) rather than a free jurisdiction
// picker - unlike Ministry's Counsellor Performance page, a District Admin
      ...
      <div className="space-y-4">
        ...
        <div className="bg-white p-4 rounded-xl border border-gray-200/80 shadow-sm">
          ...
          <p className="text-[11px] text-gray-400 mt-1">
            ...
            Investigating Officer roles in your district, and how their own referral queue is actually moving. Click a row to see the actual open cases behind its count.
          </p>
        </div>
        ...
        <div className="bg-white p-4 rounded-xl border border-gray-200/80 shadow-sm flex flex-col sm:flex-row gap-3">
          <input
            ...
            placeholder="Search by name, designation, or station..."
            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="divide-y divide-gray-100 text-xs">
                {!jurisdictionId || perfQuery.loading ? (
                  ...
                  <tr><td colSpan={7} className="py-8 text-center text-gray-400">No coordination-role officials assigned in your district yet.</td></tr>
