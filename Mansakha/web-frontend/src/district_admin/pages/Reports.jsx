...
// District Admin's own copy of the shared Analytics & Reports page -
// simplified to just District Admin's own dashboard data (no counsellor
// branching, since this file only ever serves District Admin now).
