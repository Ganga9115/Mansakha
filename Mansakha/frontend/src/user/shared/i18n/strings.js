...
// i18next) covering the User App's Language Select screen (Build Prompt
...
// (Section 8 only calls out Language Select for User), and most other
// User screens' body copy is still English-only - also tracked there
