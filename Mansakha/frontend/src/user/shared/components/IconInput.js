...
const styles = StyleSheet.create({
  ...
  // `input` and replaced by this consistent ring on the wrapper instead.
  wrapperFocused: {
    borderColor: colors.primary,
    outlineWidth: colors.focusRingWidth, outlineColor: colors.focusRing, outlineStyle: 'solid', outlineOffset: 2,
  },
